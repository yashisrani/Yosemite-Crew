 ...
 * If the parameter is a data type.
 */
export type ParametersParameterValue = Address | Age | Attachment | boolean | CodeableConcept | Coding | ContactPoint | Count | Distance | Duration |
    HumanName | Identifier | Meta | Money | number | ParameterDefinition | Period | Quantity | Range | Ratio | Reference | SampledData | string | Timing;
