        ...
        <Container>
          <div className="AbtHeroData">
            <div className="abttopHero">
              <h2>
                Welcome to <span>Yosemite Crew</span> Where <br /> compassion
                meets code.
              </h2>
              <h4>
                For Pet Businesses,Pet parents, and Developers who want to shape
            ...
            <div className="storyTexted">
              ...
              <div className="ourstorypara">
                ...
                <h6>
                  ...
                  use, easy to recognize, and most importantly easy to love.
                  We&apos;ve spent our time deeply understanding user problems
                  so we can solve them, not add to them.
                </h6>
                <h6>
                  Why We&apos;re Different <br /> Sure, we’re open source but
                  we’re not just another codebase floating on GitHub.
                </h6>
              </div>
            </div>
          </div>
        ...
        <Container>
          <div className="AbtTeamdata">
            <div className="AbtTeamHead">
              <h2>
                <span>We&apos;re not a Company. We&apos;re a</span> Community.
              </h2>
