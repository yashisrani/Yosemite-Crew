...
function AddInventory(): React.JSX.Element {
  ...
  const validate = (data: InventoryFormData): Record<string, string> => {
    ...
    const regexChecks: {
      [K in keyof InventoryFormData]?: { regex: RegExp; message: string };
    } = {
      barCode: {
        regex: /^[0-9]{6,20}$/,
      ...
      itemName: {
        regex: /^[A-Za-z0-9\s]{2,100}$/,
        message: "Item name must be 2–100 alphanumeric characters",
      },
      genericName: {
        regex: /^[A-Za-z\s]{2,100}$/,
        message: "Generic name must contain only letters",
      },
      department: {
        regex: /^[A-Za-z\s]{2,50}$/,
      ...
      sexType: {
        ...
        message: "Sex type must be Male, Female, or Unisex",
      },
      manufacturer: {
        regex: /^[A-Za-z\s]{2,100}$/,
        message: "Manufacturer must contain only letters",
      },
      itemCategory: {
        regex: /^[A-Za-z\s]{2,100}$/,
        message: "Item category must contain only letters",
      },
      speciesSpecific1: {
        regex: /^[A-Za-z\s]{2,50}$/,
        message: "Species must contain only letters",
      },
      speciesSpecific2: {
        regex: /^[A-Za-z\s]{2,50}$/,
        message: "Species must contain only letters",
      ...
      sku: {
        regex: /^[A-Z0-9\-]{5,30}$/,
        message: "SKU must be 5–30 uppercase letters, numbers, or dashes",
      },
      strength: {
        regex: /^[0-9]{1,4}(mg|g|ml)$/,
        message: "Strength must end with mg, g, or ml (e.g., 500mg)",
      },
      ...
      perQtyPrice: {
        regex: /^\d+(\.\d{1,2})?$/,
        message: "Per qty price must be valid",
      },
      manufacturerPrice: {
        regex: /^\d+(\.\d{1,2})?$/,
        message: "Manufacturer price must be valid",
      },
      markup: {
        regex: /^\d+(\.\d{1,2})?$/,
        message: "Markup must be valid percentage",
      },
    };
        ...
        <div className="InventoryData">
            ...
            <Form>
              ...
              <Row>
                ...
                <Col md={6}>
                  ...
                  />
                  {errors.genericName && (
                    <div className="text-danger">{errors.genericName}</div>
                  )}
                </Col>
              </Row>
              ...
              <Row>
                <Col md={6}>
                  <DynamicSelect
                    options={[{ value: "department", label: "Department 1" }]}
                ...
                <Col md={6}>
                  ...
                  /> */}
                  {errors.sexType && (
                    <div className="text-danger">{errors.sexType}</div>
                  )}
                </Col>
              </Row>
              ...
              <Row>
                <Col md={6}>
                  <DynamicSelect
                    ...
                    onChange={setCountry}
                    inname="country"
                    placeholder="Species Specific 1 (optional)"
                  />
                  {/* <FormInput
                    intype="text"
                    inname="speciesSpecific1"
                    value={formData.speciesSpecific1}
                    inlabel="Species Specific 1"
                    onChange={handleChange}
                  /> */}
                  {errors.speciesSpecific1 && (
                    <div className="text-danger">{errors.speciesSpecific1}</div>
                  )}
                </Col>
                <Col md={6}>
                  <DynamicSelect
                    ...
                    onChange={setCountry}
                    inname="country"
                    placeholder="Species Specific 2 (optional)"
                  />
                  {/* <FormInput
                    intype="text"
                    inname="speciesSpecific2"
                    value={formData.speciesSpecific2}
                    inlabel="Species Specific 2"
                    onChange={handleChange}
                  /> */}
                  {errors.speciesSpecific2 && (
                    <div className="text-danger">{errors.speciesSpecific2}</div>
                  )}
                </Col>
              </Row>
              ...
              <Row>
                <Col md={6}>
                  ...
                  />
                  {errors.onHand && (
                    <div className="text-danger">{errors.onHand}</div>
                  )}
                </Col>
                <Col md={6}>
                  <FormInput
                    intype="number"
                    inname="perQtyPrice"
                    value={formData.perQtyPrice}
                    inlabel="$ Per Qty Price"
                    onChange={handleChange}
                  />
                  {errors.perQtyPrice && (
                    <div className="text-danger">{errors.perQtyPrice}</div>
                  )}
                </Col>
              </Row>
              ...
              <Row>
                <Col md={3}>
                  ...
                  />
                  {errors.batchNumber && (
                    <div className="text-danger">{errors.batchNumber}</div>
                  )}
                </Col>
                <Col md={3}>
                  <FormInput
                ...
                <Col md={3}>
                  ...
                  />
                  {errors.strength && (
                    <div className="text-danger">{errors.strength}</div>
                  )}
                </Col>
                <Col md={3}>
                  <QuantityInput
              ...
              <Row>
                ...
                <Col md={3}>
                  ...
                  />
                  {errors.markup && (
                    <div className="text-danger">{errors.markup}</div>
                  )}
                </Col>
                <Col md={3}>
                  <FormInput
                  ...
                  />
                  {errors.upc && (
                    <div className="text-danger">{errors.upc}</div>
                  )}
                </Col>
                <Col md={3}>
                  <FormInput
          ...
          <div className="InventryBtn">
            <Button onClick={handleSubmit}>
              <Icon icon="carbon:checkmark-filled" width="24" height="24" /> Add
              Inventory
            </Button>
          </div>
        </div>
