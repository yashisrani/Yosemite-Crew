        ...
        <Slider {...settings}>
            ...
            <div className='RelateSlidecard'>
                <div className="ReltartPic">
                    <Image src={`${process.env.VITE_BASE_IMAGE_URL}/ArticlePage/Rls1.png`} alt="Rls1" />
                </div>
            ...
            <div className='RelateSlidecard'>
                <div className="ReltartPic">
                    <Image src={`${process.env.VITE_BASE_IMAGE_URL}/ArticlePage/Rls2.png`} alt="Rls2" />
                </div>
                <div className="RelateInner">
                    <div className="Reltdate">
                        <h6>Training</h6>
            ...
            <div className='RelateSlidecard'>
                <div className="ReltartPic">
                    <Image src={`${process.env.VITE_BASE_IMAGE_URL}/ArticlePage/Rls3.png`} alt="Rls3" />
                </div>
                <div className="RelateInner">
                    <div className="Reltdate">
                        <h6>Wellness</h6>
            ...
            <div className='RelateSlidecard'>
                <div className="ReltartPic">
                    <Image src={`${process.env.VITE_BASE_IMAGE_URL}/ArticlePage/Rls4.png`} alt="Rls4" />
                </div>
                <div className="RelateInner">
                    <div className="Reltdate">
                        <h6>Nutrition</h6>
