...
const DepartmentHeadSelector = () => {
  ...
  const handleSelectHead = useCallback((head: { name: string }) => {
                ...
                {filteredHeads.map((head) => (
                  ...
                  >
                    <label>
                      ...
                      <input type="radio" className="form-check-input" checked={selectedHead === head.name}  onChange={() => handleSelectHead(head)} />
                    </label>
                  </li>
                ))}
              </ul>
