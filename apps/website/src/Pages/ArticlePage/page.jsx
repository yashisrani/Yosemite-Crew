        ...
        <div className="Articles_Data">
          ...
          <div className="LeftArticle">
            ...
            <div className="ArticleBg">
              <img src={`${import.meta.env.VITE_BASE_IMAGE_URL}/ArticlePage/puppy.jpg`} alt="puppy" />
            ...
            <div className="ArticleInfo">
              ...
              <div className="artinfoinner" id='PuppyFood'>
                ...
                <img src={`${import.meta.env.VITE_BASE_IMAGE_URL}/ArticlePage/fedding.png`} alt="fedding" />
              ...
              <div className="artinfoinner">
                ...
                <img src={`${import.meta.env.VITE_BASE_IMAGE_URL}/ArticlePage/artcart.png`} alt="artcart" id='Bedding' />
              </div>
          ...
          <div className="RytArticle">
            ...
            <div className="blgdr">
              <div className="bldrinfo">
                <img src={`${import.meta.env.VITE_BASE_IMAGE_URL}/ArticlePage/drpic.png`} alt="drpic" />
  ...
  return <div className="explorDiv">
    <div className="bltype">
      <div className="typtext">
        <img src={`${import.meta.env.VITE_BASE_IMAGE_URL}/Homepage/P1.png`} alt="P1" />
        <h6>Animal Type</h6>
      </div>
    ...
    <div className="bltype">
      <div className="typtext">
        <img src={`${import.meta.env.VITE_BASE_IMAGE_URL}/topic.png`} alt="topic" />
        <h6>Topics</h6>
      </div>
      <div className="typeinfo">
